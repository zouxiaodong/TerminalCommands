...
//    FileManager fileManager1 = FileManager("test-files/newfile10.txt");
    FileManager fileManager3 = FileManager("test-files/test-dir");
//    FileManager fileManager4 = FileManager("test-files/file3.txt");
...
////    // Create instance of ofstream
    std::ofstream outFile1("test-files/test-dir3/outfile11.txt");
////    std::ofstream outFile2("test-files/outfile30.txt");
////    // Copy file contents into helloWorld.txt file stream
    fileManager3.dump(outFile1);
////    fileManager3.dump(outFile2);
////
////    // Test renameFile()
//    std::string newFileName = "test-files/newfile10.txt";
...
//    // Test compareFile()
//    if (fileManager1.compareFile(fileManager3))
...
//    std::vector<FileManager> childresult3 = fileManager3.getChildren();
    ...
    // Test setFileName()
//    std::string newName = "test-files/helloooo.txt";
